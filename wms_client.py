...
class WMSClient:
    def __init__(self, base_url: Optional[str] = None, username: Optional[str] = None, 
        ...
        self.verify_ssl = verify_ssl if verify_ssl is not None else wms_config.get("verify_ssl", True)
        self.timeout = timeout if timeout != 30.0 else wms_config.get("default_timeout", 30.0)
    ...
    def fetch_all(self, entity: str, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
