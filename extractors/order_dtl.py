...
def _flatten_order_dtl_record(order_dtl: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for num_field in ["ord_qty", "orig_ord_qty", "alloc_qty", "cost", "sale_price", 
                      "voucher_amount", "unit_declared_value", "cust_number_1", "cust_number_2", 
                      "cust_number_3", "cust_number_4", "cust_number_5", "cust_decimal_1", 
                      "cust_decimal_2", "cust_decimal_3", "cust_decimal_4", "cust_decimal_5", 
                      "min_shipping_tolerance_percentage", "max_shipping_tolerance_percentage", 
                      "ordered_uom_qty"]:
    ...
    for int_field in ["seq_nbr", "batch_number_id", "voucher_print_count", "status_id", 
                      "ob_lpn_type_id", "orig_order_ref_id"]:
    ...
    for ts_field in ["create_ts", "mod_ts", "voucher_exp_date", "cust_date_1", "cust_date_2", 
